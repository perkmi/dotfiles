...
hl.monitor({ output = "HDMI-A-1", mode = "1920x1080@60", position = "auto", scale = "auto" })
...
hl.on("hyprland.start", function () 
  hl.exec_cmd("/usr/lib/polkit-kde-authentication-agent-1 & $HOME/.config/waybar/reloadway.sh & swaync & hyprpaper & copyq --start-server & hypridle & nm-applet & elephant")
end)
...
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio_changer.py"))
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("fcitx5"))
...
hl.window_rule({ match = { class = ".+polkit-kde.+" }, float = true })
hl.window_rule({ match = { class = "nm-connect.+" }, float = true })
hl.window_rule({ match = { class = ".+pavucontrol" }, float = true })
hl.window_rule({ match = { class = ".+kcalc" }, float = true })
hl.window_rule({ match = { title = "AudioSink" }, float = true })
